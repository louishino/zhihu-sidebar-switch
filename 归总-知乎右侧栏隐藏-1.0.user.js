...
(function() {
    ...
    // 获取右边栏和主栏元素
    const getRightSidebar = () => document.querySelector('div.Question-sideColumn') || document.querySelector('div.css-1qyytj7');
    const getMainColumn = () => document.querySelector('div.Question-mainColumn') || document.querySelector('div.Topstory-mainColumn');
